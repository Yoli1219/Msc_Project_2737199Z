...
for gamma in gamma_values:
    ...
    for t in range(T):
        ...
        actions[t] = action  # Record the current selected node
    ...
    plt.title(f'Node Selection IID Using EXP3, Gamma = {gamma}', fontsize=20)
    plt.legend()
    plt.show()
...
plt.title('Cumulative Regret for IID data Using Different Gamma', fontsize=20)
plt.legend()
plt.show()
...
plt.title('Cumulative Reward Over Time for IID data Using Different Gamma', fontsize = 20)
plt.legend()
plt.show()
