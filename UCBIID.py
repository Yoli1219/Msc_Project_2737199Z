...
# Minimum latency at each step
optimal_latencies = np.min(true_means) 
...
# Storage for cumulative regrets and rewards for different c values
cumulative_regrets = {}
cumulative_rewards = {}
...
for c in c_values:
    ...
    plt.title(f'Node Selection for IID data Using UCB, c = {c}', fontsize=20)
    plt.show()
...
plt.title('Cumulative Regret for IID data Using UCB', fontsize=20)
plt.legend()
plt.show()
...
plt.title('Average Single-Step Regret for IID data Using Different c Values', fontsize=20)
plt.legend()
plt.show()
...
plt.title('Cumulative Reward for IID data Using Different c Values', fontsize=20)
plt.legend()
plt.show()
